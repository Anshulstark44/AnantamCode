...
const LearningGrid = () => {
  return (
    <div className=' grid grid-cols-1 xl:grid-cols-4 mb-12 p-5 lg:w-fit'>
      {
        LearningGridArray.map((card,index)=>{
            return (
                <div key={index} className={`${index===0 && "lg:col-span-2 lg:h-64 p-5"}
                 ${card.order %2===1 ? "bg-richblack-700 lg:h-64 p-5" : "bg-richblack-800 lg:h-64 p-5"}
                 ${card.order===3 && "lg:col-start-2 lg:h-64 p-5 "}
